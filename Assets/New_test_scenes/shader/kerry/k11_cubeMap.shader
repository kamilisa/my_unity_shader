    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //cubeMap
                // float4 cube_map = texCUBElod(_cubeMap,float4(reflect_view_dr,_cubeMapMip)); //用法复杂，第二个参数需要填入视线镜像向量以及mipmap采样值
                ...
                //final_ex
                float3 final = unity_env_map_de * _mainColor.rgb * ambient;
